...
-- Dumping database structure for handmadestore3
CREATE DATABASE IF NOT EXISTS `handmadestore3` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `handmadestore3`;

-- Dumping structure for table handmadestore3.banner_items
...
-- Dumping data for table handmadestore3.banner_items: ~3 rows (approximately)
...
-- Dumping structure for table handmadestore3.category
...
-- Dumping data for table handmadestore3.category: ~5 rows (approximately)
...
-- Dumping structure for table handmadestore3.discount
...
-- Dumping data for table handmadestore3.discount: ~6 rows (approximately)
...
-- Dumping structure for table handmadestore3.image
...
-- Dumping data for table handmadestore3.image: ~538 rows (approximately)
...
-- Dumping structure for table handmadestore3.inventory
...
-- Dumping data for table handmadestore3.inventory: ~235 rows (approximately)
INSERT INTO `inventory` (`productId`, `quantity`, `costPrice`, `soldOut`, `createDate`, `costPriceUpdate`) VALUES
	(1, 35, 50000.00, 25, '2024-12-16 15:27:48', 50000.00),
	(2, 21, 55000.00, 0, '2024-07-03 09:27:17', 60000.00),
	(3, 24, 50000.00, 5, '2024-12-22 19:55:36', 40000.00),
	(4, 15, 24000.00, 0, '2024-06-29 07:16:10', 24000.00),
	(5, 5, 24000.00, 0, '2024-06-29 07:16:10', 24000.00),
	(6, 13, 50000.00, 2, '2024-12-18 09:28:20', 50000.00),
	(7, 19, 30000.00, 4, '2024-12-18 09:28:20', 30000.00),
	(8, 40, 7000.00, 8, '2024-12-22 20:04:08', 7000.00),
	(9, 50, 15000.00, 15, '2024-12-23 08:20:33', 15000.00),
	(10, 34, 18500.00, 6, '2024-12-23 08:20:33', 18500.00),
	...
	(41, 10, 450000.00, 1, '2024-12-23 04:53:29', 450000.00),
	(42, 8, 450000.00, 2, '2024-12-23 04:53:29', 450000.00),
	(43, 13, 104000.00, 7, '2024-12-23 02:55:20', 104000.00),
	(44, 16, 104000.00, 0, '2024-06-29 07:16:10', 104000.00),
	(45, 24, 147000.00, 7, '2024-12-23 08:20:33', 147000.00),
	(46, 1, 402000.00, 1, '2024-12-23 03:11:21', 402000.00),
	(47, 4, 1350000.00, 4, '2024-12-23 08:12:27', 1350000.00),
	...
	(102, 10, 95000.00, 1, '2024-12-22 20:00:27', 95000.00),
	...
	(141, 25, 35000.00, 2, '2024-12-23 04:53:29', 35000.00),
	(142, 12, 75000.00, 0, '2024-06-29 07:16:10', 75000.00),
	(143, 30, 25000.00, 0, '2024-06-29 07:16:10', 25000.00),
	(144, 18, 110000.00, 4, '2024-12-23 04:53:29', 110000.00),
	...
	(150, 25, 55000.00, 4, '2024-12-23 02:33:04', 55000.00),
	...
	(155, 14, 85000.00, 7, '2024-12-23 07:55:14', 85000.00),
...
-- Dumping structure for table handmadestore3.inventory_receipts
...
-- Dumping data for table handmadestore3.inventory_receipts: ~0 rows (approximately)

-- Dumping structure for table handmadestore3.key_user
...
-- Dumping data for table handmadestore3.key_user: ~13 rows (approximately)
INSERT INTO `key_user` (`id`, `title`, `publicKey`, `status`, `createdTime`, `updatedTime`, `userId`) VALUES
	(1, 'lenovo-thinkbook-g7', 'MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA2mlIGzpi9oZm8cKcnHMI', 1, '2024-12-15 13:14:40', '2024-12-16 04:19:23', 15),
	(2, 'iphone6-KEQIC', '-----BEGIN PUBLIC KEY-----\\nWwIDAQAB\n-----END PUBLIC KEY-----', 1, '2024-09-15 13:14:40', NULL, 15),
	(3, 'bluetooth-g7', '-----BEGIN PUBLIC KEY-----\\nkQIDAQAB\n-----END PUBLIC KEY-----', 1, '2024-12-15 13:45:02', NULL, 15),
	(4, 'abc_dine', '-----BEGIN PUBLIC KEY-----\\n+QIDAQAB\n-----END PUBLIC KEY-----', 1, '2024-12-15 13:59:01', NULL, 15),
	(5, 'ze_ze', '-----BEGIN PUBLIC KEY-----\\nqwIDAQAB\n-----END PUBLIC KEY-----', 1, '2024-12-15 15:13:55', NULL, 15),
	(6, 'ten-ne', '-----BEGIN PUBLIC KEY-----\\n7wIDAQAB\n-----END PUBLIC KEY-----', 1, '2024-12-16 01:37:51', NULL, 15),
	(7, 'asus-i7', '-----BEGIN PUBLIC KEY-----\\n-----END PUBLIC KEY-----', 1, '2024-12-16 05:18:23', NULL, 15),
	(8, 'asus-g4-etc', '-----BEGIN PUBLIC KEY-----\\n-----END PUBLIC KEY-----', 1, '2024-12-22 05:09:24', NULL, 15),
	(9, 'iphone6', '-----BEGIN PUBLIC KEY-----\\nxQIDAQAB\n-----END PUBLIC KEY-----', 1, '2024-12-22 07:30:21', NULL, 16),
	(10, 'laptop-acer-nitro5', '-----BEGIN PUBLIC KEY-----\\n2QIDAQAB\n-----END PUBLIC KEY-----', 1, '2024-12-22 17:05:00', NULL, 16),
	(11, 'acer-nitro5', '-----BEGIN PUBLIC KEY-----\\nRQIDAQAB\n-----END PUBLIC KEY-----', 1, '2024-12-23 02:29:46', '2024-12-23 03:10:23', 11),
	(12, 'samsung-g7', '-----BEGIN PUBLIC KEY-----\\nZwIDAQAB\n-----END PUBLIC KEY-----', 1, '2024-12-23 02:30:15', '2024-12-23 02:54:01', 11),
	(13, 'samsung-s7-hcm', '-----BEGIN PUBLIC KEY-----\\nZQIDAQAB\n-----END PUBLIC KEY-----', 1, '2024-12-23 07:53:03', '2024-12-23 08:19:35', 13);

-- Dumping structure for table handmadestore3.log
...
-- Dumping data for table handmadestore3.log: ~0 rows (approximately)

-- Dumping structure for table handmadestore3.order
CREATE TABLE IF NOT EXISTS `order` (
  ...
  `shippingFee` decimal(10,1) NOT NULL DEFAULT 0.0,
  `userId` int(11) NOT NULL,
  ...
  KEY `fk_publicKey` (`publicKeyId`),
  CONSTRAINT `fk_order` FOREIGN KEY (`userId`) REFERENCES `user` (`id`),
  CONSTRAINT `fk_publicKey` FOREIGN KEY (`publicKeyId`) REFERENCES `key_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;

-- Dumping data for table handmadestore3.order: ~32 rows (approximately)
INSERT INTO `order` (`id`, `totalPrice`, `orderDate`, `status`, `consigneeName`, `consigneePhoneNumber`, `address`, `shippingFee`, `userId`, `note`, `publicKeyId`, `signature`) VALUES
	(15, 150000.0, '2024-12-15 17:00:00', 0, 'Tôn Ngộ Không', '0671821176', 'Đường Nguyễn Trãi, Xã Phiêng Khoài, Huyện Yên Châu, Sơn La', 30000.0, 13, NULL, 0, ''),
	(16, 170000.0, '2024-12-15 17:00:00', 0, 'Tôn Ngộ Không', '0671821176', 'Chất chứa những điều chua chát, Xã Chiềng Xuân, Huyện Vân Hồ, Sơn La', 30000.0, 13, NULL, 0, ''),
	(17, 150000.0, '2024-12-17 17:00:00', 4, 'Trư Bát Giớ', '0871881103', 'Đường 18 Phạn Văn Đồng, Xã Tân Tiến, Huyện Văn Giang, Hưng Yên', 30000.0, 15, NULL, 0, ''),
	(18, 228000.0, '2024-12-22 17:00:00', 4, 'Người Cồng', '0341007611', 'Đường 18 Phạn Văn Đồng, Xã Bản Hon, Huyện Tam Đường, Lai Châu', 30000.0, 16, NULL, 10, ''),
	(19, 88000.0, '2024-12-22 17:00:00', 4, 'Người Cồng', '0341007611', 'Nguyễn Chí Thanh, Xã Nguyễn Huân, Huyện Đầm Dơi, Cà Mau', 30000.0, 16, NULL, 10, ''),
	(20, 119000.0, '2024-12-22 17:00:00', 0, 'Người Cồng', '0341007611', 'Đường 18 Phạn Văn Đồng, Xã Đại Đồng Thành, Thị xã Thuận Thành, Bắc Ninh', 30000.0, 16, NULL, 10, ''),
	(21, 88000.0, '2024-12-22 17:00:00', 4, 'Người Cồng', '0341007611', 'Nguyễn Chí Thanh, Xã Vị Đông, Huyện Vị Thuỷ, Hậu Giang', 30000.0, 16, NULL, 10, ''),
	(22, 88000.0, '2024-12-22 17:00:00', 0, 'Người Cồng', '0341007611', 'Đường 18 Phạn Văn Đồng, Xã An Bình, Thị xã Thuận Thành, Bắc Ninh', 30000.0, 16, NULL, 10, ''),
	(23, 88000.0, '2024-12-22 17:00:00', 0, 'Người Cồng', '0341007611', 'Đường 18 Phạn Văn Đồng, Phường Đình Bảng, Thị xã Từ Sơn, Bắc Ninh', 30000.0, 16, NULL, 10, ''),
	(24, 88000.0, '2024-12-22 17:00:00', 0, 'Người Cồng', '0341007611', 'Đường 18 Phạn Văn Đồng, Phường Đình Bảng, Thị xã Từ Sơn, Bắc Ninh', 30000.0, 16, NULL, 10, ''),
	(25, 158329.0, '2024-12-22 17:00:00', 1, 'Người Cồng', '0341007611', 'Nguyễn Chí Thanh, Xã Bình Dương, Huyện Gia Bình, Bắc Ninh', 30000.0, 16, NULL, 10, ''),
	(26, 158329.0, '2024-12-22 17:00:00', 4, 'Người Cồng', '0341007611', 'Nguyễn Chí Thanh, Xã Bình Dương, Huyện Gia Bình, Bắc Ninh', 30000.0, 16, NULL, 10, ''),
	(27, 710000.0, '2024-12-22 17:00:00', 1, 'Người Cồng', '0341007611', 'Đường Nguyễn Trãi, Xã Đại Bái, Huyện Gia Bình, Bắc Ninh', 30000.0, 16, NULL, 10, ''),
	(28, 710000.0, '2024-12-22 17:00:00', 4, 'Người Cồng', '0341007611', 'Đường Nguyễn Trãi, Xã Đại Bái, Huyện Gia Bình, Bắc Ninh', 30000.0, 16, NULL, 10, ''),
	(29, 290000.0, '2024-12-22 17:00:00', 4, 'Người Cồng', '0341007611', 'Chất chứa những điều chua chát, Xã Phú An, Huyện Châu Thành, Hậu Giang', 30000.0, 16, NULL, 10, ''),
	(30, 749987.0, '2024-12-22 17:00:00', 4, 'Người Cồng', '0341007611', 'Đường vào tim em sao băng giá, Xã Mường Giàng, Huyện Quỳnh Nhai, Sơn La', 30000.0, 16, NULL, 10, ''),
	(31, 378000.0, '2024-12-22 17:00:00', 1, 'Người Cồng', '0341007611', 'Đường Glucozo, Xã Mi Hòa, Huyện Kim Bôi, Hòa Bình', 30000.0, 16, NULL, 10, ''),
	(32, 260000.0, '2024-12-22 17:00:00', 4, 'Người Cồng', '0341007611', 'Đường 18 Phạn Văn Đồng, Xã Nguyễn Huân, Huyện Đầm Dơi, Cà Mau', 30000.0, 16, NULL, 10, ''),
	(33, 193000.0, '2024-12-22 17:00:00', 1, 'Người Cồng', '0341007611', 'Đường này thật xaa, Xã Khánh Bình Tây, Huyện Trần Văn Thời, Cà Mau', 30000.0, 16, NULL, 10, ''),
	(34, 88000.0, '2024-12-22 20:04:07', 1, 'Người Cồng', '0341007611', 'Nguyễn Chí Thanh, Xã Ngọc Chánh, Huyện Đầm Dơi, Cà Mau', 30000.0, 16, NULL, 10, ''),
	(35, 159329.0, '2024-12-23 02:33:04', 1, 'Nguyễn Quang Hải', '0875244129', 'Đường về nhà, Phường Na Lay, Thị xã Mường Lay, Điện Biên', 30000.0, 11, NULL, 12, ''),
	(36, 289329.0, '2024-12-23 02:35:07', 4, 'Nguyễn Quang Hải', '0875244129', 'Đường glucozo, Xã An Bình, Huyện Lạc Thủy, Hòa Bình', 30000.0, 11, NULL, 11, ''),
	(37, 328329.0, '2024-12-23 02:55:20', 0, 'Nguyễn Quang Hải', '0875244129', 'Đường glucozo, Thị trấn Điện Biên Đông, Huyện Mường Nhé, Điện Biên', 30000.0, 11, NULL, 12, ''),
	(38, 328329.0, '2024-12-23 02:55:38', 0, 'Nguyễn Quang Hải', '0875244129', 'Đường glucozo, Thị trấn Điện Biên Đông, Huyện Mường Nhé, Điện Biên', 30000.0, 11, NULL, 12, ''),
	(39, 1039000.0, '2024-12-23 03:11:21', 4, 'Nguyễn Quang Hải', '0875244129', 'Đường về nhà, Phường Sông Đà, Thị xã Mường Lay, Điện Biên', 30000.0, 11, NULL, 11, ''),
	(40, 338000.0, '2024-12-23 04:48:14', 0, 'Nguyễn Quang Hải', '0875244129', 'Đường 83 Phạm Ngũ Lão, Xã An Bình, Huyện Lạc Thủy, Hòa Bình', 30000.0, 11, NULL, 12, ''),
	(41, 1558000.0, '2024-12-23 04:53:29', 0, 'Nguyễn Quang Hải', '0875244129', '23A Thôn Đại Hạ, Xã Nguyễn Huân, Huyện Đầm Dơi, Cà Mau', 30000.0, 11, NULL, 12, ''),
	(42, 1728000.0, '2024-12-23 06:16:20', 1, 'Nguyễn Quang Hải', '0875244129', 'Đường vào tim em ôi sao băng giá, Phường Thuận An, Thị xã Long Mỹ, Hậu Giang', 30000.0, 11, NULL, 12, ''),
	(43, 1948000.0, '2024-12-23 06:46:43', 1, 'Nguyễn Quang Hải', '0875244129', 'Thanh niên viện hàn lâm, Xã Minh Hải, Huyện Văn Lâm, Hưng Yên', 30000.0, 11, NULL, 12, ''),
	(44, 2010000.0, '2024-12-23 07:55:14', 2, 'Tôn Ngộ Không', '0671821176', 'Đường 18/A Võ Văn Ngân, Xã Chiềng Bằng, Huyện Quỳnh Nhai, Sơn La', 30000.0, 13, NULL, 13, ''),
	(45, 1728000.0, '2024-12-23 08:12:27', 4, 'Tôn Ngộ Không', '0671821176', '20A/8 Võ Nguyên Giáp, Xã Châu Phong, Huyện Quế Võ, Bắc Ninh', 30000.0, 13, NULL, 13, ''),
	(46, 328000.0, '2024-12-23 08:20:33', 1, 'Tôn Ngộ Không', '0671821176', 'Đường Võ Hán, Xã Chim Vàn, Huyện Bắc Yên, Sơn La', 30000.0, 13, NULL, 13, '');

-- Dumping structure for table handmadestore3.order_details
CREATE TABLE IF NOT EXISTS `order_details` (
  `orderId` int(11) NOT NULL,
  `productId` int(11) NOT NULL,
  `quantity` int(11) NOT NULL,
  `sellingPrice` decimal(10,1) NOT NULL,
  `finalSellingPrice` decimal(10,1) NOT NULL,
...
-- Dumping data for table handmadestore3.order_details: ~71 rows (approximately)
INSERT INTO `order_details` (`orderId`, `productId`, `quantity`, `sellingPrice`, `finalSellingPrice`, `explainPriceDifference`) VALUES
	(15, 1, 1, 70000.0, 70000.0, NULL),
	(15, 7, 1, 50000.0, 50000.0, NULL),
	(16, 3, 1, 70000.0, 70000.0, NULL),
	(16, 6, 1, 70000.0, 70000.0, NULL),
	(17, 6, 1, 70000.0, 70000.0, NULL),
	(17, 7, 1, 50000.0, 50000.0, NULL),
	(18, 8, 1, 19000.0, 19000.0, NULL),
	(18, 9, 1, 39000.0, 39000.0, NULL),
	(18, 155, 1, 140000.0, 140000.0, NULL),
	(19, 8, 1, 19000.0, 19000.0, NULL),
	(19, 9, 1, 39000.0, 39000.0, NULL),
	(20, 3, 1, 70000.0, 70000.0, NULL),
	(20, 8, 1, 19000.0, 19000.0, NULL),
	(21, 8, 1, 19000.0, 19000.0, NULL),
	(21, 9, 1, 39000.0, 39000.0, NULL),
	(22, 8, 1, 19000.0, 19000.0, NULL),
	(22, 9, 1, 39000.0, 39000.0, NULL),
	(25, 3, 1, 70000.0, 70000.0, NULL),
	(25, 8, 1, 19000.0, 19000.0, NULL),
	(25, 9, 1, 39000.0, 39000.0, NULL),
	(25, 43, 1, 329.0, 329.0, NULL),
	(27, 144, 1, 170000.0, 170000.0, NULL),
	(27, 150, 1, 90000.0, 90000.0, NULL),
	(27, 155, 3, 140000.0, 140000.0, NULL),
	(29, 144, 1, 170000.0, 170000.0, NULL),
	(29, 150, 1, 90000.0, 90000.0, NULL),
	(30, 3, 1, 70000.0, 70000.0, NULL),
	(30, 42, 1, 649000.0, 649000.0, NULL),
	(30, 43, 3, 329.0, 329.0, NULL),
	(31, 3, 1, 70000.0, 70000.0, NULL),
	(31, 8, 1, 19000.0, 19000.0, NULL),
	(31, 9, 1, 39000.0, 39000.0, NULL),
	(31, 45, 1, 220000.0, 220000.0, NULL),
	(32, 150, 1, 90000.0, 90000.0, NULL),
	(32, 155, 1, 140000.0, 140000.0, NULL),
	(33, 102, 1, 163000.0, 163000.0, NULL),
	(34, 8, 1, 19000.0, 19000.0, NULL),
	(34, 9, 1, 39000.0, 39000.0, NULL),
	(35, 9, 1, 39000.0, 39000.0, NULL),
	(35, 43, 1, 329.0, 329.0, NULL),
	(35, 150, 1, 90000.0, 90000.0, NULL),
	(36, 9, 1, 39000.0, 39000.0, NULL),
	(36, 43, 1, 329.0, 329.0, NULL),
	(36, 45, 1, 220000.0, 220000.0, NULL),
	(37, 9, 1, 39000.0, 39000.0, NULL),
	(37, 10, 1, 39000.0, 39000.0, NULL),
	(37, 43, 1, 329.0, 329.0, NULL),
	(37, 45, 1, 220000.0, 220000.0, NULL),
	(39, 45, 1, 220000.0, 220000.0, NULL),
	(39, 46, 1, 649000.0, 649000.0, NULL),
	(39, 155, 1, 140000.0, 140000.0, NULL),
	(40, 9, 1, 39000.0, 39000.0, NULL),
	(40, 10, 1, 39000.0, 39000.0, NULL),
	(40, 141, 1, 60000.0, 60000.0, NULL),
	(40, 144, 1, 170000.0, 170000.0, NULL),
	(41, 41, 1, 649000.0, 649000.0, NULL),
	(41, 42, 1, 649000.0, 649000.0, NULL),
	(41, 141, 1, 60000.0, 60000.0, NULL),
	(41, 144, 1, 170000.0, 170000.0, NULL),
	(42, 9, 1, 39000.0, 39000.0, NULL),
	(42, 10, 1, 39000.0, 39000.0, NULL),
	(42, 47, 1, 1620000.0, 1620000.0, NULL),
	(43, 9, 1, 39000.0, 39000.0, NULL),
	(43, 10, 1, 39000.0, 39000.0, NULL),
	(43, 45, 1, 220000.0, 220000.0, NULL),
	(43, 47, 1, 1620000.0, 1620000.0, NULL),
	(44, 45, 1, 220000.0, 220000.0, NULL),
	(44, 47, 1, 1620000.0, 1620000.0, NULL),
	(44, 155, 1, 140000.0, 140000.0, NULL),
	(45, 9, 1, 39000.0, 39000.0, NULL),
	(45, 10, 1, 39000.0, 39000.0, NULL),
	(45, 47, 2, 3240000.0, 3240000.0, NULL),
	(46, 9, 1, 39000.0, 39000.0, NULL),
	(46, 10, 1, 39000.0, 39000.0, NULL),
	(46, 45, 1, 220000.0, 220000.0, NULL);

-- Dumping structure for table handmadestore3.product
...
INSERT INTO `product` (`id`, `name`, `description`, `sellingPrice`, `stock`, `categoryId`, `discountId`, `isSale`) VALUES
	...
	(3, 'Thiệp chúc mừng Sweet Mint', 'Mẫu thiệp SWEET MINT - ngọt ngào như viên kẹo bạc hà! \nKích thước lớn hơn thông thường: 11x18cm, gồm bì thư, giấy viết thông điệp và thiệp; \nChủ đề có sẵn: chúc mừng sinh nhật, valentine, 8/3, 20/10, 20/11; \nLiên lạc ngay với Craft & More Vietnam nếu bạn muốn làm thiệp theo chủ đề riêng; \nThiệp làm handmade tỉ mỉ với vật liệu giấy cứng, giấy mỹ thuật, hoa lá cỏ khô,,, rất thân thiện môi trường; \nTùy biến kích thước, câu chữ, logo cho nhóm, công ty, đoàn thể,,, \nLưu ý: Thiệp được làm thủ công-handmade với các vật liệu hoa, lá, cỏ, giấy,,, nên các chi tiết có thể khác đôi chút cho từng sản phẩm nhưng phong cách (concept) luôn thống nhất theo các mẫu,', 70000.00, 9, 1, 6, 1),
	...
	(5, 'Thiệp handmade Amazing Carto', 'Mẫu thiệp AMAZING CARTON cảm hứng từ những tấm bìa cứng thô ráp! \nKích thước: 9x14cm; \nChủ đề có sẵn: chúc mừng sinh nhật, valentine, 8/3, 20/10, 20/11; \nLiên lạc ngay với Craft & More Vietnam nếu bạn muốn làm thiệp theo chủ đề riêng; \nThiệp làm handmade tỉ mỉ với vật liệu giấy cứng, giấy mỹ thuật, hoa lá cỏ khô,,, rất thân thiện môi trường; \nTùy biến kích thước, câu chữ, logo cho nhóm, công ty, đoàn thể,,, \nLưu ý: Thiệp được làm thủ công-handmade với các vật liệu hoa, lá, cỏ, giấy,,, nên các chi tiết có thể khác đôi chút cho từng sản phẩm nhưng phong cách (concept) luôn thống nhất theo các mẫu,', 39000.00, 0, 1, 0, 1),
	(6, 'Thiệp handmade lớn Beauty & the White', 'Kích thước 11x18cm \nChất liệu giấy mỹ thuật cao cấp \nChủ đề đa dạng, tùy biến \nPhù hợp với hầu hết các đối tượng, các dịp như 8/3, 20/10, 20/11, sinh nhật, chúc mừng,,,', 70000.00, 0, 1, 1, 1),
	(7, 'Thiệp da bò độc đáo', 'Kích thước: 10x13,5cm \n\n- Chất liệu da bò chọn lọc, charm đồng, giấy dó \n\n- Tùy biến theo ý riêng: theo mục đích tặng (sinh nhật, 20/11, 20/10, 8/3, valentine 14/2, giáng sinh v,v,,,) hoặc thay đổi hoàn toàn thông điệp theo ý riêng,', 50000.00, 0, 1, NULL, 1),
	(8, 'Thiệp dấu sáp mini', 'Thiệp mini đơn giản nhưng đẹp! \n\nThiệp làm & đóng sáp thủ công handmade; \n\nKích thước 6x9cm, gồm giấy viết thông điệp bên trong thiệp; \n\nVật liệu: giấy craft, sáp đóng dấu, dây thừng, giấy mỹ thuật', 19000.00, 0, 1, NULL, 1),
	(9, 'Thiệp handmade Vintage Film', 'Kích thước: 10x14,5cm \n\n- Chất liệu giấy mỹ thuật đặc biệt, charm đồng \n\n- Sản phẩm gồm thiệp, tấm giấy ghi thông điệp, bì thư vintage \n\n- Tùy biến theo ý riêng: theo mục đích tặng (sinh nhật, 20/11, 20/10, 8/3, valentine 14/2, giáng sinh v,v,,,) hoặc thay đổi hoàn toàn thông điệp theo ý riêng,', 39000.00, 9, 1, NULL, 1),
	(10, 'Thiệp handmade vintage vải bố', '- Kích thước: 10x14,5cm \n\n- Chất liệu vải bố nâu, charm đồng, giấy dó \n\n- Tùy biến theo ý riêng: theo mục đích tặng (sinh nhật, 20/11, 20/10, 8/3, valentine 14/2, giáng sinh v,v,,,) hoặc thay đổi hoàn toàn thông điệp theo ý riêng,', 39000.00, 27, 1, NULL, 1),
	...
	(41, 'Scrapbook That Time', '- Kích thước 21x21x5cm; \n\n- Trang trí được 30-50 ảnh đủ các kích thước 4x6cm đến 13x18cm; \n\n- Sản phẩm được làm thủ công, chăm chút từng chi tiết nhỏ; scrapbook có phong cách, màu sắc đậm chất vintage, hoài cổ rất được yêu thích; \n\n- Scrapbook có thể thiết kế, tùy biến chủ đề theo ý riêng,', 649000.00, 9, 2, NULL, 1),
	(42, 'Scrapbook Sweet Mint', '- Kích thước 21x21x5cm \n\n- Trang trí được 30-50 ảnh đủ các kích thước 4x6cm đến 13x18cm \n\n- Sản phẩm được làm thủ công, chăm chút từng chi tiết nhỏ \n\n- Scrapbook có thể thiết kế, tùy biến chủ đề theo ý riêng', 649000.00, 5, 2, NULL, 1),
	(43, 'Scrapbook Fly That Time', '- Kích thước 14,5 x 21,5 x 5cm \n\n- Trang trí được 30 ảnh 6x9cm \n\n- Sản phẩm được làm handmade tỉ mỉ từng chi tiết nhỏ', 329.00, 0, 2, NULL, 1),
	(44, 'Album ảnh handmade Fly Sweet Mint', '- Sản phẩm được làm handmade chăm chút tỉ mỉ \n\n- Kích thước 14,5 x 21,5 x 5cm \n\n- Trang trí được 30 hình 6x9cm \n\n- Có thể tùy biến, thiết kế chủ đề theo yêu cầu riêng', 329000.00, 0, 2, NULL, 1),
	(45, 'Album ảnh tự trang trí Love Story (Xanh)', 'Màu xanh Vintage huyền bí cùng thiết kế theo phong cách Vintage đầy bí ẩn sẽ làm cuốn album của bạn thêm thu hút và độc đáo,', 220000.00, 17, 2, NULL, 1),
	(46, 'Scrapbook Retro Clock', '- Màu sắc: Nâu - trắng, \n\n- Kích thước: 20 x 20cm, \n\n- Chất liệu: Giấy cứng cao cấp, được trang trí hoàn toàn bằng tay (100% handmade), \n\n- Số trang: 11, có thể dán được 40-60 hình các size khác nhau,', 649000.00, 0, 2, NULL, 1),
	(47, 'Scrapbook Vintage', 'Scrapbook handmade cao cấp đậm chất vintage Just be me Quyển scrapbook (một dạng sổ ảnh handmade) được làm thủ công với thiết kế hoàn toàn khác biệt, chắc chắn, chứa được nhiều hình hơn so với các scrapbook khác, Màu,,,', 1620000.00, 0, 2, NULL, 1),
	...
	(102, 'Bình sứ trang trí Vintage', 'Bình sứ trang trí đẹp nhẹ nhàng phù hợp trang trí shop, studio, quán cafe, nhà hàng, phòng khách', 163000.00, 9, 5, NULL, 1),
	...
	(141, 'Nón Handmade Cho Bé', 'Nón handmade cho bé được làm từ vải tự nhiên và có thiết kế độc đáo. Bảo vệ bé khỏi ánh nắng mặt trời và là phụ kiện thời trang dễ thương.', 60000.00, 23, 4, NULL, 1),
	...
	(144, 'Gối Massage Thủ Công', 'Gối massage thủ công giúp giảm căng thẳng và mệt mỏi. Sản phẩm được làm bằng vật liệu an toàn cho da và có thiết kế êm ái. Kích thước: 30cm x 30cm', 170000.00, 12, 3, NULL, 1),
	...
	(150, 'Hộp Đựng Đồ Trang Sức Gỗ', 'Hộp đựng đồ trang sức gỗ là sản phẩm thủ công với chất liệu gỗ tự nhiên. Thiết kế nhỏ gọn và tiện lợi cho việc bảo quản trang sức. Kích thước: 10cm x 10cm x 5cm', 90000.00, 17, 3, NULL, 1),
	...
	(155, 'Gối Trang Trí Embroidery', 'Gối trang trí embroidery là sản phẩm thủ công với họa tiết thêu tay tinh tế. Sự kết hợp của màu sắc và chi tiết tạo nên một sản phẩm trang trí độc đáo. Kích thước: 45cm x 45cm', 140000.00, 7, 3, NULL, 1),
...
-- Dumping structure for table handmadestore3.rate
...
-- Dumping data for table handmadestore3.rate: ~8 rows (approximately)
...
-- Dumping structure for table handmadestore3.receptitem
...
-- Dumping data for table handmadestore3.receptitem: ~0 rows (approximately)

-- Dumping structure for table handmadestore3.role
...
-- Dumping data for table handmadestore3.role: ~3 rows (approximately)
INSERT INTO `role` (`id`, `name`) VALUES
	(-1, 'owner'),
	(0, 'admin'),
	(2, 'user');

-- Dumping structure for table handmadestore3.tips
...
-- Dumping data for table handmadestore3.tips: ~3 rows (approximately)
...
-- Dumping structure for table handmadestore3.user
...
-- Dumping data for table handmadestore3.user: ~18 rows (approximately)
INSERT INTO `user` (`id`, `name`, `phoneNumber`, `email`, `password`, `createDate`, `status`, `roleId`) VALUES
	...
	(13, 'Tôn Ngộ Không', '0671821176', 'trungkien19203@gmail.com', 'HcAWujhP8PZAsYe/3icfc9N4b1s=', '2023-12-21 12:02:03', 'Bình Thường', 1),
	(14, 'Đường Tăng Tạng', '0315821901', 'trungkien9203@gmail.com', 'jHdhq9r1HYxgovt/ST+OaNAaF/w=', '2023-12-21 12:02:30', 'Bình Thường', 1),
...
-- Dumping structure for trigger handmadestore3.set_default_costPriceUpdate
